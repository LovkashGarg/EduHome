...
<div className='sm:col-span-2  min-h-[60px] text-start text-[30px] px-[40px] py-[20px] text-black flex items-center '>
...
<div className='routes hidden sm:col-span-6 min-h-[60px] sm:flex sm:flex-row sm:justify-end  sm:block  text-[24px] text-black mx-[15px] '>
    <div className='m-[20px] hover:bg-gray-400 mx-[7px] px-[10px] rounded-[20px]'><Link to='/'>Home</Link></div>
     {Role=='Student'? <div className='m-[20px] mx-[10px]  px-[10px] hover:bg-gray-400 rounded-[20px] px-[5px]'>Cart</div> : Role==='Teacher' ? <div className='m-[20px] hover:bg-gray-400 rounded-[20px] px-[5px] mx-[10px] '><Link to='/TeacherDashboard'>DashBoard</Link></div> :null}
    {Role==='Student' ?(null)
    : Role==='Teacher'? (<div className='m-[20px] mx-[6px]  px-[10px] hover:bg-gray-400 rounded-[20px] '><Link to='/createliveclasses'> Create Live</Link></div>)
    :null
      }
        {Role=='Student'? <div className='m-[20px] ml-[10px]  px-[10px]  hover:bg-gray-400 rounded-[20px] '><Link to='/SearchResults'>Search </Link></div> : Role==='Teacher' ? <div className='my-[20px] mx-[10px] hover:bg-gray-400 rounded-[20px] px-[5px]'><Link to={`/CourseCreationForm/${Email}`}>Create Course</Link></div> :null}
    <div className='m-[20px] mx-[10px] px-[10px] hover:bg-gray-400 rounded-[20px]  '><Link to='/profile '> Profile </Link></div>
</div>
<div className='sm:col-span-2 min-h-[60px] hidden  sm:block sm:flex  sm:items-center sm:justify-center mr-[10px] '>
    <Link className={`${showsignup? "show":"hidden"} bg-pink-500 min-w-[80px] sm:text-[20px] md:text-[24px] sm:px-[20px] sm:min-w-[130px] text-white shadow rounded-lg`} to='/signup' >SignUp</Link>

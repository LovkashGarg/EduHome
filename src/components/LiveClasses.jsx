...
handleallclassesdata();
  ...
  const Liveclasscard = (props) => {
    ...
    return (
      <>
        <div className="w-[250px] h-[220px] sm:w-[300px] sm:h-[320px] mx-[50px] border-[3px] rounded-[30px] border-green-500 flex flex-col items-center justify-center ">
         
         <div className='flex flex-row items-center justify-between gap-[20px]'>
          <div className="bg-red-600 text-white w-[120px] rounded-[20px] text-center">{props.classTeacher}</div>
          <div className="bg-red-600 text-white w-[80px] rounded-[20px] text-center">{props.timepassed}</div>
          </div>
  ...
  return (
    <>
      ...
      <div className="liveclassescarousel w-[100vw] h-[300px] grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ">
  {data2.map(item =>(

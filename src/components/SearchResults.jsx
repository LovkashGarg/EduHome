...
//         },[]);
  return (
    <>
    <form onSubmit={fetchData}><div className='flex w-[100%] justify-center items-center h-[60px] m-[20px] gap-[20px]'>
  ...
  <button className='bg-red-600 text-white w-[100px] h-[50px] rounded-[40px]' type='submit'  >Search</button> 
    ...
    {results.map((item)=>(
         <div className="w-[850px] h-[200px] sm:w-[800px] sm:h-[270px] mx-[50px] border-[3px] rounded-[30px] border-green-500 flex flex-col my-[10px] items-center justify-center ">
